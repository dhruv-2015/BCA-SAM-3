...
//Application Title
define('APP_TITLE', "Dhruv's File Manager");
...
$auth_users = array(
    'admin' => '$2y$10$woper.xiejj7KxtAZXu7uugivRCDK9y8yT4NuSMMVyqqNOZ.bd/qy', //admin@123
    'afhrjndofeouf' => '$2y$10$Fg6Dz8oH9fPoZ2jJan5tZuv6Z4Kp7avtQ9bDfrdRntXtPeiMAZyGO' //12345
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://github.com/dhruv-2015" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">Dhruv Programmers</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
                        <h3><a href="https://github.com/dhruv-2015" target="_blank" class="app-v-title"> Dhruv's File Manager <?php echo VERSION; ?></a></h3>
                        </p>
                        <p>Author: Dhruv Patel</p>
                        <p>Mail Us: <a href="mailto:chadasaniyadhruv@gmail.com">chadasaniyadhruv@gmail.com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://github.com/dhruv-2015/wiki" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://github.com/dhruv-2015/issues" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        <?php if (!FM_READONLY) : ?>
            ...
            <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Dhruv's File Manager <?php echo VERSION; ?></a></div>
        <?php else : ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Dhruv's File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
...
class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = "Dhruv's File Manager<br>Error: Cannot load configuration";
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
?>
    ...
    <head>
        ...
        <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with Dhruv's File Manager">
...
<?php
    ...
    function lng($txt)
    {
        ...
        // English Language
        $tr['en']['AppName']        = "Dhruv's File Manager";
